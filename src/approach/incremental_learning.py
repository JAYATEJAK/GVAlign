...
class Inc_Learning_Appr:
    ...
    def train(self, t, trn_loader, val_loader, args, tst_loader = None):
    ...
    def train_loop(self, t, trn_loader, val_loader, args, tst_loader):
        ...
        for e in range(self.nepochs):
            ...
            # Valid
            clock3 = time.time()
            valid_loss, valid_acc, _ = self.eval(t, tst_loader[t])
            clock4 = time.time()
            print(' ValidT: time={:5.1f}s loss={:.3f}, TAw acc={:5.1f}% |'.format(
    ...
    def eval(self, t, val_loader, return_pred_targets=False):
    ...
    def calculate_metrics(self, outputs, targets):
        ...
        return hits_taw, hits_tag, pred, targets
